...
class Qwen3VLModel(LLM):
    ...
    def get_image_token_count(self, curr_content):
        ...
        dummy_text = f"{self.processor.vision_start_token}{self.processor.image_token}{self.processor.vision_end_token}"
        inputs = self.processor(text=dummy_text, images=image, add_special_tokens=False, return_tensors="pt")
